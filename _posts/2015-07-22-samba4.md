...
Finalmente atualize o IP do seu servidor de domínio secundário no arquivo`/etc/resolv.conf` do mesmo servidor que para o nosso caso é 192.168.1.5:
