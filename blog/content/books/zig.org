...
Acima, o código ~SQR(1+2)~ foi escrito esperando como resultado o valor 9, mas o C o transformou em outra coisa. Já em [[https://ziglang.org/][Zig]], não existem macros desse tipo. O equivalente seria uma função inline, que mantém o comportamento previsível:
